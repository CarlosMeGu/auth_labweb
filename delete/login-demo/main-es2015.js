...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container\" *ngIf=\"auth.auth0Client$ | async\">\n  <app-hero></app-hero>\n  <app-home-content></app-home-content>\n</div>\n");
...
/* harmony import */ var _components_hero_hero_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/hero/hero.component */ "./src/app/components/hero/hero.component.ts");
/* harmony import */ var _components_home_content_home_content_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/home-content/home-content.component */ "./src/app/components/home-content/home-content.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _components_home_content_home_content_component__WEBPACK_IMPORTED_MODULE_14__["HomeContentComponent"],
...
let AuthService = class AuthService {
    ...
    getUser$(options) {
        return this.auth0Client$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["concatMap"])((client) => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["from"])(client.getUser(options))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(user => this.userProfileSubject$.next(user)));
    }
    localAuthSetup() {
    ...
    handleAuthCallback() {
        ...
        if (params.includes('code=') && params.includes('state=')) {
            ...
            Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(cbRes => {
...
module.exports = __webpack_require__(/*! /Users/carlosmelgoza/Downloads/01-login/src/main.ts */"./src/main.ts");
